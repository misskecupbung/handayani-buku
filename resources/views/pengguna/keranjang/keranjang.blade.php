...
<div class="bg-light py-3" data-aos="fade-up" data-aos-delay="100">
    <div class="container" id="keranjang">
        <div class="row">
    ...
    <div class="container">
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="product-name py-2">Judul Buku</th>
                    ...
                    <tbody>
                        ...
                        @if($item->jumlah_beli > $item->stok_buku)
                        <tr>
                            <td colspan="6">
                                <span class="alert alert-danger">
                                    <b>Warning!</b> Stok <i>'{{ $item->judul_buku }}'</i> kurang dari jumlah yang ingin di beli. Silahkan periksa detail buku untuk melihat jumlah stok.
                                </span>
                            </td>
                        </tr>
                        <?php $warning = true; ?>
                        ...
                        <tr>
                            <td class="product-thumbnail">
                                {{ Html::image(asset('storage/buku/'.$item->foto_buku), $item->judul_buku, ['class' => 'img-fluid px-0', 'width' => '100']) }}
                            </td>
                            <td class="product-name">
                                <a href="{{ route('detail_buku', ['id_buku' => $item->id_buku]) }}">
                                <h2 class="h5">{{ $item->judul_buku }}<br><small>Berat Satuan : <i>{{ $item->berat_buku.'gram' }}</i></small></h2>
                                </a>
                            </td>
                            <td>{{ Rupiah::create($item->harga_satuan) }}</td>
                            <td width="200">
                                {{ Form::open(['route' => ['update_keranjang', $item->id_buku], 'method' => 'PUT']) }}
                            ...
                            <td>
                                {{ Form::open(['route' => ['delete_keranjang', $item->id_buku], 'method' => 'DELETE']) }}
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="row mb-5">
                    <div class="col-md-6">
                        <a href="{{ route('buku') }}" class="btn btn-outline-primary btn-sm btn-block">Lanjutkan Belanja</a>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p class="lead mb-5">Silahkan pilih buku favorit anda di katalog kami.</p>
                <p><a href="{{ route('buku') }}" class="btn btn-sm btn-primary">Lanjut Berbelanja</a></p>
            </div>
        </div>
    </div>
</div>
