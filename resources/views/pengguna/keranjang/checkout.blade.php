                ...
                <div class="p-3 p-lg-5 border">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control" name="provinsi" id="inp_provinsi" required></select>
                        </div>
                        <div class="col-md-6">
                            <label for="inp_kota" class="text-black">Kota</label>
                            <select class="form-control" name="kota" id="inp_kota" required></select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <select class="form-control" name="layanan" id="inp_layanan" required></select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="atas_nama" class="form-control" autocomplete="off" required>
                        </div>
                        <div class="col-md-4">
                            <label for="inp_atas_nama" class="text-black">No. Rekening</label>
                            <input type="text" name="no_rekening" class="form-control" autocomplete="off" required>
                        </div>
                    </div>
                        ...
                        <div class="p-3 p-lg-5 border">
                            <table class="table site-block-order-table mb-5">
                                ...
                                <tbody id="detail_pesanan">
                                    ...
                                    <?php $total_berat = $item->berat_buku * $item->jumlah_beli; ?>
                                        <tr>
                                            <td>
                                                {{ $item->judul_buku }} <strong class="mx-2">x</strong> {{ $item->jumlah_beli }}<br>
                                                <small>Berat : {!! $item->berat_buku.' gram - <strong>Total Berat : '.$total_berat.' gram</strong>' !!}</small>
                                            </td>
                                ...
                                <div class="collapse show" id="collapsebank">
                                    <div class="py-2">
                                        <p class="mb-0 text-black">
                                            ...
                                            {{ Html::image(asset('pengguna_assets/images/bri_logo.jpg')) }} <br>306701002891507 a/n Ari Jati Permana<br><br>
                                            <small>
