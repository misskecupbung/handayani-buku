    ...
    <div class="container">
        <div class="row" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="col-md-5 mx-auto">
                {{ Form::open(['route' => ['save_bukti', $id_pesanan], 'files' => true, 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                    <div class="p-3 p-lg-5 border">
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::file('bukti_pembayaran', ['class' => 'form-control', 'id' => 'inp_bukti_pembayaran', 'style' => 'border: 0;', 'enctype' => 'multipart/form-data']) }}
