...
<div class="site-section pt-5">
    <div class="container" id="detail">
        <div class="row mb-5">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <b>Tanggal Upload:</b><br> {{ date('H:i:s | d-m-Y', strtotime($data_detail->tanggal_upload)) }}
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="site-blocks-table col-md-8 mt-5" id="kofirmasi">
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="py-2 px-2">Nama Buku</th>
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <td>Total Biaya</td>
                                    <td>:</td>
                                    <?php $total = $total_biaya + $data_detail->ongkos_kirim; ?>
                            ...
                            <table class="table">
                                ...
                                @if($data_detail->dibatalkan == 0)
                                    ...
                                    @if($data_detail->status_pesanan >= 3)
                                        ...
                                        <td>{{ date('H:i:s | d-m-Y', strtotime($data_detail->tanggal_dikirim)) }}</td>
                                    @endif
                                    </tr>
                                    @if($data_detail->status_pesanan >= 3)
                                    <tr>
                                        <th><b>Di Terima Pada : </b></th>
                                        <td>{{ !empty($data_detail->tanggal_diterima) ? date('H:i:s | d-m-Y', strtotime($data_detail->tanggal_diterima))  : '-' }}</td>
