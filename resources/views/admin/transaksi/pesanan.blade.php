...
<h1>
    Kelola Pesanan
    <small>Manajemen pesanan</small>
</h1>
<ol class="breadcrumb">
    <li><a href="{{ route('beranda_admin') }}"><i class="fa fa-home"></i> Beranda</a></li>
    <li class="active"><i class="fa fa-shopping-cart fa-fw"></i> pesanan</li>
</ol>
@endsection
...
<div class="row">
    <div class="col-md-12 col-sm-12">
        ...
        <div class="box box-default">
            <div class="box-header">
                <h3 class="box-title">
                    <i class="fa fa-list fa-fw"></i> Daftar Pesanan Yang Sedang Di Proses
                </h3>
            </div>
            <div class="box-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($item->dibatalkan == 0)
                                        ...
                                        @if($carbon::parse(explode(' ', $carbon::now())[1])->lessThanOrEqualTo($carbon::parse($item->batas_pembayaran)) && $item->status_pesanan == 0)
                                            <span class="label bg-yellow">
                                                Menunggu Pembayaran
                                            </span>

                                        {{-- @elseif($carbon::parse(explode(' ', $carbon::now())[0])->lessThanOrEqualTo($carbon::parse($item->batas_pembayaran)) && $item->status_pesanan == 0) --}}
                                        @else
                                ...
                                <td>
                                    @if($item->dibatalkan == 0)
                                        @if($carbon::parse(explode(' ', $carbon::now())[1])->lessThanOrEqualTo($carbon::parse($item->batas_pembayaran)) && $item->status_pesanan == 0)
                                            ...
                                            <a href="#" class="btn btn-warning btn-xs batalkan_pesanan" data-toggle="modal" data-target="#batalkan_pesanan" id="{{ $counter1 }}">
                                                <i class="fa fa-ban fa-fw"></i> Batalkan
                                            </a>
                                        @else
                                            @if($item->status_pesanan == 1)
                                                {{-- detail pesanan     --}}
                                                <a class="btn btn-info btn-xs" href="{{ route('detail_pesanan_admin', [$item->id_pesanan]) }}">
                                                    <i class="fa fa-info fa-fw"></i> Detail
                                                </a>
                                                {{-- proses pesanan --}}
                                                <a href="#" class="btn btn-success btn-xs proses_pesanan" data-toggle="modal" data-target="#proses_pesanan" id="{{ $counter1 }}">
                                                    <i class="fa fa-refresh fa-fw"></i> Proses
                                                </a>
                                                <a href="#" class="btn btn-warning btn-xs batalkan_pesanan" data-toggle="modal" data-target="#batalkan_pesanan" id="{{ $counter1 }}">
                                                    <i class="fa fa-ban fa-fw"></i> Batalkan
                                                </a>
                                                <a href="#" class="btn btn-danger btn-xs hapus_pesanan" data-toggle="modal" data-target="#hapus_pesanan" id="{{ $counter1 }}">
    ...
    <div class="col-md-12 col-sm-12">
        <div class="box box-default">
            <div class="box-header">
                <h3 class="box-title">
                    <i class="fa fa-list fa-fw"></i> Daftar Pesanan Yang Siap Di Kirim
                </h3>
            </div>
            <div class="box-body">
                        ...
                        @foreach ($data_pesanan as $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" class="btn btn-success btn-xs kirim_pesanan" data-toggle="modal" data-target="#kirim_pesanan" id="{{ $counter2 }}">
                                        <i class="fa fa-truck fa-fw"></i> Kirim
                                    </a>
                                    <a href="#" class="btn btn-warning btn-xs proses_pesanan" data-toggle="modal" data-target="#proses_pesanan" id="{{ $counter2 }}">
                                        <i class="fa fa-ban fa-fw"></i> Batalkan
                                    </a>
                                    {{-- <div class="btn-group">
        ...
        <div class="modal-content">
            ...
            {!! Form::open(['method' => 'PUT', 'id' => 'form_kirim_pesanan']) !!}
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="simpan" value="true" class="btn btn-sm btn-success"><i class="fa fa-paper-plane fa-fw"></i> Kirim pesanan</button>
                </div>
            {!! Form::close() !!}
        </div>
        <!-- /.modal-content -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            {!! Form::open(['method' => 'PUT', 'id' => 'form_edit_pesanan']) !!}
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm pull-left" data-dismiss="modal"><i class="fa fa-close fa-fw"></i> Batal</button>
                    <button type="submit" name="simpan" value="true" class="btn btn-sm btn-primary"><i class="fa fa-check fa-fw"></i> Simpan Perubahan</button>
                </div>
            {!! Form::close() !!}
        </div>
        <!-- /.modal-content -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            {!! Form::open(['method' => 'PUT', 'id' => 'form_proses_pesanan']) !!}
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm pull-left" data-dismiss="modal"><i class="fa fa-close fa-fw"></i> Batal</button>
                    <button type="submit" name="simpan" value="true" class="btn btn-sm btn-success"><i class="fa fa-refresh fa-fw"></i> Proses pesanan</button>
                </div>
            {!! Form::close() !!}
        </div>
        <!-- /.modal-content -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            {!! Form::open(['method' => 'PUT', 'id' => 'form_batalkan_pesanan']) !!}
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm pull-left" data-dismiss="modal"><i class="fa fa-close fa-fw"></i> Batal</button>
                    <button type="submit" name="simpan" value="true" class="btn btn-sm btn-warning"><i class="fa fa-refresh fa-fw"></i> Proses</button>
                </div>
            {!! Form::close() !!}
        </div>
        <!-- /.modal-content -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            {!! Form::open(['method' => 'DELETE', 'id' => 'form_hapus_pesanan']) !!}
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm pull-left" data-dismiss="modal"><i class="fa fa-close fa-fw"></i> Batal</button>
                    <button type="submit" name="simpan" value="true" class="btn btn-sm btn-danger"><i class="fa fa-trash fa-fw"></i> Hapus pesanan</button>
                </div>
            {!! Form::close() !!}
        </div>
        <!-- /.modal-content -->
