...
<h1>
    Laporan Transaksi
    <small>Cetak laporan transaksi</small>
</h1>
<ol class="breadcrumb">
    <li><a href="{{ route('beranda_admin') }}"><i class="fa fa-home"></i> Beranda</a></li>
    <li class="active"><i class="fa fa-file-text fa-fw"></i> Laporan Transaksi</li>
</ol>
@endsection
    ...
    <div class="col-md-12 col-sm-12">
        ...
        <div class="box box-default">
            <div class="box-header">
                <h3 class="box-title">
                    <i class="fa fa-list fa-fw"></i> Daftar Transaksi Selesai
                </h3>
            </div>
            <div class="box-body">
                    ...
                    <div class="col-md-12 col-md-offset-2">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" class="form-control" name="awal" id="datepicker1" placeholder="Tanggal Awal" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" class="form-control" name="akhir" id="datepicker2" placeholder="Tanggal Akhir" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="form-group pull-right">
                            <button type="submit" class="btn btn-primary" target="_blank"><i class="fa fa-file-text fa-fw"></i> Print Laporan</button>
                        </div>
                    </div>
                    {{ Form::close() }}
                </div>
